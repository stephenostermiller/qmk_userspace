...
enum unicode_names {
    ...
    U_FRAC_3_4, U_FRAC_7_8, U_TIP, U_INFO, U_DO_NOT, U_NO_ENTRY, U_KLAXON, U_FROWN, U_FRAC_1_10, U_HAM_MEN,
};
...
enum tap_dance_keycodes {
    LCDT_SHFT, LCDT_CRTL, LCDT_META, LCDT_ALT, RCDT_ALT, RCDT_META, RCDT_CRTL, RCDT_SHFT, LAY_OUT, FANC_ALPH, MUTE_MVS, HOME_TOP, END_BTM, EM_ELL, NEXT_FF, PREV_RW,
...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [FANC_ALPH] = EZTD_TAP_HOLD_DTAP(UNICODE_FANCY_ALPHABET_CYCLE, UNICODE_FANCY_ALPHABET_MOMENTARY, KC_CALCULATOR),
    ...
    [EM_ELL] = EZTD_TAP_HOLD(UM(U_EM_DASH), UM(U_ELLIPSIS)),
    [NEXT_FF] = EZTD_TAP_HOLD(KC_MEDIA_NEXT_TRACK, KC_MEDIA_FAST_FORWARD),
    [PREV_RW] = EZTD_TAP_HOLD(KC_MEDIA_PREV_TRACK, KC_MEDIA_REWIND),
    [PLAY_PLYR] = EZTD_TAP_HOLD_DTAP(KC_MEDIA_PLAY_PAUSE, UM(U_BULLET), KC_MEDIA_SELECT),
    ...
    [EM_SMILE] = EZTD_TAP_HOLD_DTAP(UM(U_SMILE0), UM(U_SMILE1), UM(U_SMILE2)),
    [EM_LOL] = EZTD_TAP_HOLD_DTAP(UM(U_LAUGH), UM(U_SNICKER), UM(U_ROFL)),
    [EM_LOVE] = EZTD_TAP_HOLD_DTAP_DHOLD(UM(U_HEART), UM(U_HEART_HANDS), UM(U_HEART_EYES), UM(U_HEART_SMILE)),
    [EM_LIKE] = EZTD_TAP_HOLD_DTAP_DHOLD_TTAP_THOLD(UM(U_THMB_UP), UM(U_100), UM(U_HNDSAIR), UM(U_MUSIC_2), UM(U_MUSIC_3), UM(U_FIRE)),
    [EM_CAUTN] = EZTD_TAP_HOLD_DTAP_DHOLD_TTAP_THOLD(UM(U_INFO), UM(U_TIP), UM(U_WARNING), UM(U_DO_NOT), UM(U_NO_ENTRY), UM(U_KLAXON)),
    [EM_PARTY] =  EZTD_TAP_HOLD_DTAP_DHOLD_TTAP_THOLD(UM(U_PARTY0), UM(U_PARTY1), UM(U_PARTY2), UM(U_PARTY3), UM(U_PARTY4), UM(U_PARTY5)),
    [EM_LGL_IP] = EZTD_TAP_HOLD_DTAP(UM(U_CPYRGHT), UM(U_RGSTRD), UM(U_TRDMRK)),
    [EM_BALLOT] = EZTD_TAP_HOLD_DTAP_DHOLD_TTAP_THOLD(UM(U_WHTCHK), UM(U_CROSS), UM(U_BOX_CHECKED), UM(U_BOX_CROSSED), UM(U_BOX_EMPTY), UM(U_BOX_EMPTY)),
    [EM_SAD] =  EZTD_TAP_HOLD_DTAP_DHOLD_TTAP_THOLD(UM(U_THMB_DN), UM(U_MELTFC), UM(U_FROWN), UM(U_SKULL), UM(U_CRY), UM(U_CRY)),
    //[EM_CD_RVW] =  EZTD_TAP_HOLD_DTAP_DHOLD_TTAP_THOLD(UM(U_EYES), UM(U_BUG), UM(U_WHTCHK), UM(U_WHTCHK), UM(U_SHIP), UM(U_DELIVERY)),
    //[MSC_FACE] = EZTD_TAP_HOLD_DTAP(UM(U_MND_BLWN), UM(U_SALUTE), UM(U_TEARS)),
    //[MSC_ICN] = EZTD_TAP_HOLD_DTAP_DHOLD(UM(U_LINK), UM(U_PALMTR), UM(U_HAM_MEN), UM(U_SPARKLES)),
    [MTH_ROOT] = EZTD_TAP_HOLD_DTAP(UM(U_ROOT_2), UM(U_ROOT_3), UM(U_ROOT_4)),
    [MTH_PWR] = EZTD_TAP_HOLD_DTAP_DHOLD_TTAP_THOLD(UM(U_POW_2), UM(U_POW_3), UM(U_POW_4), UM(U_POW_5), UM(U_POW_6), UM(U_POW_7)),
    [MTH_CLCLS] = EZTD_TAP_HOLD_DTAP_DHOLD_TTAP_THOLD(UM(U_DELTA), UM(U_INTEGRAL), UM(U_SUM), UM(U_INTEGRAL_2), UM(U_PARTIAL_DIFF), UM(U_PRIME)),
    [MTH_SET] = EZTD_TAP_HOLD_DTAP_DHOLD_TTAP_THOLD(UM(U_SET_ELEMENT), UM(U_SET_NOT_ELEMENT), UM(U_SET_SUB), UM(U_SET_SUB_EQUAL), UM(U_SET_UNION), UM(U_SET_INTERSECTION)),
    [MTH_PAREN] = EZTD_TAP_HOLD(KC_LEFT_PAREN, KC_RIGHT_PAREN),
    [MTH_CONST] = EZTD_TAP_HOLD_DTAP_DHOLD_TTAP_THOLD(UM(U_PI), UM(U_IMAGINARY_I), UM(U_EULER), UM(U_IMAGINARY_J), UM(U_EMPTY_SET), UM(U_PRIME_2)),
    [F1_FRAC] = EZTD_TAP_HOLD_DTAP(KC_F1, UM(U_FRAC_1_10), UM(U_FRAC_1_10)),
    [F2_FRAC] = EZTD_TAP_HOLD_DTAP(KC_F2, UM(U_FRAC_1_2), UM(U_FRAC_1_2)),
    [F3_FRAC] = EZTD_TAP_HOLD_DTAP(KC_F3, UM(U_FRAC_1_3), UM(U_FRAC_1_3)),
    [F4_FRAC] = EZTD_TAP_HOLD_DTAP(KC_F4, UM(U_FRAC_1_4), UM(U_FRAC_1_4)),
    [F5_FRAC] = EZTD_TAP_HOLD_DTAP(KC_F5, UM(U_FRAC_2_3), UM(U_FRAC_2_3)),
    [F6_FRAC] = EZTD_TAP_HOLD_DTAP(KC_F6, UM(U_FRAC_3_4), UM(U_FRAC_3_4)),
    [F7_FRAC] = EZTD_TAP_HOLD_DTAP(KC_F7, UM(U_FRAC_1_8), UM(U_FRAC_1_8)),
    [F8_FRAC] = EZTD_TAP_HOLD_DTAP(KC_F8, UM(U_FRAC_3_8), UM(U_FRAC_3_8)),
    [F9_FRAC] = EZTD_TAP_HOLD_DTAP(KC_F9, UM(U_FRAC_5_8), UM(U_FRAC_5_8)),
    [F10_FRAC] = EZTD_TAP_HOLD_DTAP(KC_F10, UM(U_FRAC_7_8), UM(U_FRAC_7_8)),
};
...
/*  KEY COLUMN 1,  KEY COLUMN 2,  KEY COLUMN 3,  KEY COLUMN 4,  KEY COLUMN 5,  KEY COLUMN 6,  KEY COLUMN 7,      KEY COLUMN 8,  KEY COLUMN 9,  KEY COLUMN 10, KEY COLUMN 11, KEY COLUMN 12, KEY COLUMN 13, KEY COLUMN 14, */
    TD(MUTE_MVS),  KC_1,          KC_2,          KC_3,          KC_4,          KC_5,          TD(PLAY_PLYR),     TD(EM_ELL), KC_6,          KC_7,          KC_8,          KC_9,          KC_0,          KC_BSLS,
...
/*  KEY COLUMN 1,  KEY COLUMN 2,  KEY COLUMN 3,  KEY COLUMN 4,  KEY COLUMN 5,  KEY COLUMN 6,  KEY COLUMN 7,      KEY COLUMN 8,  KEY COLUMN 9,  KEY COLUMN 10, KEY COLUMN 11, KEY COLUMN 12, KEY COLUMN 13, KEY COLUMN 14, */
    ...
    TD(EM_LOVE),   XXXXXXX,       TD(EW_ARROW),  TD(W_ARROW),   XXXXXXX,       TD(E_ARROW),                                     KC_KP_4,       KC_KP_5,       KC_KP_6,       TD(ADDS),      TD(MTH_PWR),   TD(MTH_SET),
    TD(EM_LOL),    XXXXXXX,       TD(DIAG_ARROW),TD(SW_ARROW),  TD(S_ARROW),   TD(SE_ARROW),  TD(EM_CAUTN),      TD(MULTIPLIES),KC_KP_1,       KC_KP_2,       KC_KP_3,       TD(EQUALS),    TD(MTH_ROOT),  KC_NUM_LOCK,
...
/*  KEY COLUMN 1,  KEY COLUMN 2,  KEY COLUMN 3,  KEY COLUMN 4,  KEY COLUMN 5,  KEY COLUMN 6,  KEY COLUMN 7,      KEY COLUMN 8,  KEY COLUMN 9,  KEY COLUMN 10, KEY COLUMN 11, KEY COLUMN 12, KEY COLUMN 13, KEY COLUMN 14, */
    TD(MUTE_MVS),  KC_1,          KC_2,          KC_3,          KC_4,          KC_5,          TD(PLAY_PLYR),     UM(U_EM_DASH), KC_6,          KC_7,          KC_8,          KC_9,          KC_0,          TD(NEXT_FF),
