...
keycodes['UFA_NC']={'tap':'icon/fancy-negative-circled.svg'}
keycodes['UFA_SQ']={'tap':'icon/fancy-squared.svg'}
keycodes['UFA_NSQ']={'tap':'icon/fancy-negative-squared.svg'}
keycodes['UFA_SCR']={'tap':'icon/fancy-script.svg'}
keycodes['UFA_SB']={'tap':'icon/fancy-script-bold.svg'}
keycodes['UFA_FRK']={'tap':'icon/fancy-fraktur.svg'}
keycodes['UFA_FB']={'tap':'icon/fancy-fraktur-bold.svg'}
keycodes['UFA_REG']={'tap':'icon/fancy-regional.svg'}
keycodes['UFA_MON']={'tap':'icon/fancy-monospaced.svg'}
keycodes['UFA_ITC']={'tap':'icon/fancy-italic.svg'}
